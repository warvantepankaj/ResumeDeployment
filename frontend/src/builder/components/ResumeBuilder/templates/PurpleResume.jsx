...
export function PurpleResume({ resumeData = {}, compact = false, length = 0 }) {
  ...
  const hasNewTechSkills = !isTechArray && (
  ...
  const showSkillsSection = hasNewTechSkills || hasLegacyTechSkills || hasSoftSkills || hasLanguages;

  // --- EXPORT LOGIC ---
 

  return (
    <div id="resume-preview" className="flex justify-center items-center border border-gray-100">
                      ...
                      <div>
                        <div className="leading-[1.2]">
                          ...
                          <p className="font-normal pl-6 text-[14px] text-gray-800 dark:text-gray-300">
                            {edu.degree}{edu.field && ','} {edu.field} {edu.gpa ? <span className="inline-block">, CGPA :&nbsp;</span> : ""}
              ...
              <div className="mb-2 pl-1">
                ...
                {hasLegacyTechSkills && (
                  <p className="text-[14px] text-gray-800 dark:text-gray-300 pl-3">
                    <span className="font-semibold">Technical Skills : </span> {techSkills.join(", ")}
                  </p>
                )}
                ...
                {!isTechArray && techSkills.programmingLanguages?.length > 0 && (
                  <p className="text-[14px] text-gray-800 dark:text-gray-300 pl-3">
                    <span className="font-semibold">Programming Languages : </span> {techSkills.programmingLanguages.join(", ")}
                  </p>
                )}
                {!isTechArray && techSkills.frameworks?.length > 0 && (
                  <p className="text-[14px] text-gray-800 dark:text-gray-300 pl-3">
                    <span className="font-semibold">Frameworks & Libraries : </span> {techSkills.frameworks.join(", ")}
                  </p>
                )}
                {!isTechArray && techSkills.databases?.length > 0 && (
                  <p className="text-[14px] text-gray-800 dark:text-gray-300 pl-3">
                    <span className="font-semibold">Databases : </span> {techSkills.databases.join(", ")}
                  </p>
                )}
                {!isTechArray && techSkills.tools?.length > 0 && (
                  <p className="text-[14px] text-gray-800 dark:text-gray-300 pl-3">
                    <span className="font-semibold">Tools & Platforms : </span> {techSkills.tools.join(", ")}
                  </p>
                )}
